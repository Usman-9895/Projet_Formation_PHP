<!DOCTYPE html>
    ...
    <a class="navbar-brand" href="index.php"> <img src="img/logo.png" width="150px"  alt="banlieu emploi"></a>
        ...
        <div class="login-form">
            ...
            <form action="inscription_traitement.php" method="post">
                <h2 class="text-center text-success">Inscription <i class="fas fa-user-plus"></i></h2>       
                ...
                <div class="form-group">
                    <input type="password" name="password_retaper" class="form-control" placeholder="Saisissez le mot de passe à nouveau" required="required" autocomplete="off">
                </div>
                <div class="form-group">
                    <button type="submit" class="btn btn-success btn-block">Inscription</button>
                </div>    
            </form>
            <h6 class="text-center"> Se <a href="connexion.php" class="text-success">connecter</a> avec un compte existant</h6>
        </div>
        <style>
            .login-form {
               width: 340px;
...
<!-- article -->
<section id="portfolio" class="bg-white text-cloud">
